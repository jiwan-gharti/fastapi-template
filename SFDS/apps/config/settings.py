...
PROJECT_DESCRIPTION: str = config("PROJECT_DESCRIPTION", default="Driving Lesson School")
APP_SECRET_KEY: Secret = config("APP_SECRET_KEY", default="UBzPj7Qj29K4z4aeCqZ40xi8dVdTbbch", cast=Secret)
...
ASYNC_SQLALCHEMY_DATABASE_URL: str = config("ASYNC_SQLALCHEMY_DATABASE_URL", default="sqlite:///./test.db")
...
REFRESH_TOKEN_TIME_IN_MINUTES: int = config("REFRESH_TOKEN_TIME_IN_MINUTES", cast=int, default=3600)
...
EMAIL_PORT: str = config("EMAIL_PORT", default="")
...
OTP_LENGTH: int = config("OTP_LENGTH", cast=int, default=6)
